...
import { createBook, deleteBook, downloadBook, getSingleBook, listBook, updateBook } from "./bookController.ts";
...
bookRouter.get("/:bookId/download", authenticate, downloadBook);
