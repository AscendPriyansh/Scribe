...
function Logo({ showMark = true }: { showMark?: boolean }) {
  return (
    <a className="inline-flex items-center gap-2.5 text-[#111111] dark:text-[#FAFAFA]" href="#top" aria-label="Scribe home">
  ...
  return (
    <div id="top" className="min-h-screen overflow-x-hidden bg-[#FAFAFA] text-[#111111] transition-colors duration-200 dark:bg-[#111111] dark:text-[#FAFAFA]">
      <header className="sticky top-0 z-40 border-b border-[#111111]/10 bg-[#FAFAFA]/90 backdrop-blur-xl dark:border-[#FAFAFA]/15 dark:bg-[#111111]/90">
        <div className={`${shell} flex h-[73px] items-center justify-between gap-4`}>
          ...
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <button className="hidden px-1 text-[13px] font-semibold text-[#111111]/75 hover:text-[#111111] lg:block dark:text-[#FAFAFA]/75 dark:hover:text-[#FAFAFA]" onClick={() => placeholder("Login")}>Log in</button>
            <button className="hidden items-center gap-1.5 rounded-lg border border-[#111111]/20 bg-[#FAFAFA] px-3 py-2 text-[12px] font-bold text-[#111111] shadow-sm transition hover:-translate-y-0.5 hover:border-[#111111] lg:inline-flex dark:border-[#FAFAFA]/25 dark:bg-[#111111] dark:text-[#FAFAFA] dark:hover:border-[#FAFAFA]" onClick={() => placeholder("Opening your library")}>Open library <ArrowUpRight size={14} /></button>
      ...
      <main>
        <section className="relative isolate overflow-hidden border-b border-[#111111]/10 py-20 sm:py-28 dark:border-[#FAFAFA]/15">
          ...
          <div className={`${shell} grid items-center gap-14 lg:grid-cols-[.9fr_1.1fr]`}>
            <div className="max-w-[590px]">
              ...
              <div className="mt-8 flex flex-wrap gap-3"><button className={primaryButton} onClick={() => navigate("library")}>Browse the library <ArrowRight size={17} /></button><button className={outlineButton} onClick={() => navigate("contributors")}><UploadCloud size={16} /> Upload a book</button></div>
        ...
        <section className="bg-[#FAFAFA] pb-20 dark:bg-[#111111]"><div className={shell}><div className="relative overflow-hidden rounded-2xl bg-[#111111] px-6 py-20 text-center text-[#FAFAFA] sm:px-10 sm:py-24"><div className="mx-auto grid h-12 w-12 place-items-center rounded-lg bg-[#FAFAFA]"><img src="/manus-storage/scribe-logo-mark_1060d0e5.png" alt="" className="h-8 w-8 grayscale contrast-125" /></div><div className={`${eyebrow} mt-7 text-[#FAFAFA]/55`}><span className="text-[#FAFAFA]">07</span><span className="mx-2 inline-block h-px w-6 align-middle bg-current" />Return to shelf</div><p className={`${eyebrow} mt-5 text-[#FAFAFA]/55`}>A place to return to</p><h2 className="mx-auto mt-4 max-w-[800px] text-[clamp(2.8rem,5vw,5rem)] font-extrabold leading-[.95] tracking-[-.075em]">Build the library you return to.</h2><div className="mt-8 flex flex-wrap justify-center gap-3"><button className="inline-flex min-h-11 items-center gap-2 rounded-full bg-[#FAFAFA] px-5 text-[13px] font-bold text-[#111111] transition hover:opacity-85" onClick={() => placeholder("Organizing your library")}>Organize your library <ArrowRight size={17} /></button><button className="inline-flex min-h-11 items-center rounded-full border border-[#FAFAFA]/30 px-5 text-[13px] font-bold transition hover:bg-[#FAFAFA]/10" onClick={() => navigate("library")}>Browse the shelves</button></div><span className="mt-6 inline-flex items-center gap-2 font-mono text-[10px] text-[#FAFAFA]/55"><Clock3 size={13} /> Keep every useful thing you read within reach.</span></div></div></section>
      </main>
