...
export default function BackgroundBoxes(props: Record<string, unknown>) {
    return <OriginkitBaseBackgroundBoxes {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}

export { OriginkitBaseBackgroundBoxes };
